...
ALTER TABLE `goal_and_player_scores_goals`
  ADD CONSTRAINT `goal_and_player_scores_goals_ibfk_2` FOREIGN KEY (`Player_Name`, `Country_Code`) REFERENCES `player` (`Player_Name`, `Country_Code`),
  ADD CONSTRAINT `goal_and_player_scores_goals_ibfk_1` FOREIGN KEY (`Match_Number`, `Date_Year`) REFERENCES `matches` (`Match_Number`, `Date_Year`);

--
-- Constraints for table `matches`
--
ALTER TABLE `matches`
  ADD CONSTRAINT `matches_ibfk_1` FOREIGN KEY (`Date_Year`) REFERENCES `world_cup` (`Year`),
  ADD CONSTRAINT `matches_ibfk_2` FOREIGN KEY (`Stadium`) REFERENCES `stadium` (`Stadium`);

--
-- Constraints for table `match_played_by`
--
ALTER TABLE `match_played_by`
  ADD CONSTRAINT `match_played_by_ibfk_1` FOREIGN KEY (`Match_Number`, `Date_Year`) REFERENCES `matches` (`Match_Number`, `Date_Year`),
  ADD CONSTRAINT `match_played_by_ibfk_2` FOREIGN KEY (`Player_Name`, `Country_Code`) REFERENCES `player` (`Player_Name`, `Country_Code`);

--
-- Constraints for table `player`
--
ALTER TABLE `player`
  ADD CONSTRAINT `player_ibfk_1` FOREIGN KEY (`Country_Code`) REFERENCES `team` (`Country_Code`);

--
-- Constraints for table `team_participates_in_world_cup`
--
ALTER TABLE `team_participates_in_world_cup`
  ADD CONSTRAINT `team_participates_in_world_cup_ibfk_1` FOREIGN KEY (`Year`) REFERENCES `world_cup` (`Year`),
  ADD CONSTRAINT `team_participates_in_world_cup_ibfk_2` FOREIGN KEY (`Country_Code`) REFERENCES `team` (`Country_Code`);

--
-- Constraints for table `world_cup`
--
ALTER TABLE `world_cup`
  ADD CONSTRAINT `world_cup_ibfk_1` FOREIGN KEY (`Winner`) REFERENCES `team` (`Country_Code`),
  ADD CONSTRAINT `world_cup_ibfk_2` FOREIGN KEY (`Runner_Up`) REFERENCES `team` (`Country_Code`);

--
-- Constraints for table `world_cup_played_by_player`
--
ALTER TABLE `world_cup_played_by_player`
  ADD CONSTRAINT `world_cup_played_by_player_ibfk_1` FOREIGN KEY (`Year`) REFERENCES `world_cup` (`Year`),
  ADD CONSTRAINT `world_cup_played_by_player_ibfk_2` FOREIGN KEY (`Player_Name`, `Country_Code`) REFERENCES `player` (`Player_Name`, `Country_Code`);
